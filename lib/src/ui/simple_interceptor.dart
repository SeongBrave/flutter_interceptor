...
class _SimpleInterceptorState extends State<SimpleInterceptor> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(InterceptorLocalizations.getInterceptorString(context)
            .simpleInterception!),
        elevation: 0,
        actions: [
          IconButton(
      ...
      body: SafeArea(
        child: ListView(
          children: InterceptorManager.instance.transactionList
              .map((httpTransaction) {
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
              builder: (context) =>
                  InterceptorDetail(httpTransaction: httpTransaction)),
        );
      },
      child: Stack(
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  httpTransaction.statusCode.toString(),
                  style: TextStyle(
                    fontSize: 17,
                    color: statusGetColor(),
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        "${httpTransaction.method} ${httpTransaction.path}",
                        style: TextStyle(
                          fontSize: 17,
                          color: statusGetColor(),
                        ),
                      ...
                      Flex(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              getTimeStr1(httpTransaction.requestTime!),
                              style:
